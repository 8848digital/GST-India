...
doc_events = {
    ...
    "Purchase Invoice": {
        ...
        "after_submit": "india_compliance.public.py.purchase_invoice_doctype.purchase_invoice_submit",
    ...
    "Sales Invoice": {
        ...
        "after_submit": "india_compliance.public.py.sales_invoice_doctype.sales_invoice_submit",
