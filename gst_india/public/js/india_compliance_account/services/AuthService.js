export async function get_api_secret() {
    return call_server_method(
        "gst_india.gst_india.page.india_compliance_account.get_api_secret"
    );
}

export async function set_api_secret(api_secret) {
    return call_server_method(
        "gst_india.gst_india.page.india_compliance_account.set_api_secret",
        { api_secret }
    );
}
...
export function get_session() {
    return call_server_method("gst_india.gst_india.page.india_compliance_account.get_auth_session");
}

export function set_session(session) {
    call_server_method("gst_india.gst_india.page.india_compliance_account.set_auth_session", {
        session,
    });
}
